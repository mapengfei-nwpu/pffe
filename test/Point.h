...
namespace dolfin
{
  ...
  public:
    ...
    /**********************warning********************/
    // I changed Array to vector in the Point constructor below.
    // As is said, Array is a simple wrapper for a pointer to an array.
    // It is used to communicate with python which is noe necessary here.
    /*************************************************/
    Point(const std::vector<double>& x) : _x({{0.0, 0.0, 0.0}})
    {
